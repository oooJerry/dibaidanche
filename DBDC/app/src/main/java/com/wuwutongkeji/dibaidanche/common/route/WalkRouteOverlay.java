package com.wuwutongkeji.dibaidanche.common.route;
...
//    private BitmapDescriptor walkStationDescriptor= null;
	...
	public void setWalkPath(WalkPath path){
		this.walkPath = path;
	}

	public void setStartPoint(LatLonPoint start){
		startPoint = AMapServicesUtil.convertToLatLng(start);
	}

	public void setEndPoint(LatLonPoint end){
