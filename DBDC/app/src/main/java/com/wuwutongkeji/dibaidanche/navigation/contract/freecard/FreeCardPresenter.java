...
//                        mDependView.onShowCardPrice("365天=" + (entity.getYearCard() / 100) + "元");
                        System.out.println("salkdnaskfsa:"+entity.getMonthCard());
                        mDependView.onShowCardPrice(entity);
                    }
                });
    }
